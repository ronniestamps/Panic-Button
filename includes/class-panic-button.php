...
class Panic_Button
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Panic_Button_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $panic_button    The string used to uniquely identify this plugin.
	 */
	protected $panic_button;
	...
	public function __construct()
	{
		...
		$this->panic_button = 'panic-button';
	 ...
	 *
	 * - Panic_Button_Loader. Orchestrates the hooks of the plugin.
	 * - Panic_Button_i18n. Defines internationalization functionality.
	 * - Panic_Button_Admin. Defines all hooks for the admin area.
	 * - Panic_Button_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Panic_Button_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
